    				...
    				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
    					...
    					<div class="form-group row">
                            ...
                            <div class="col-md-8">
        						...
        						<textarea name="cookies_agreement_text" rows="4" class="sismoo-text-editor form-control" data-buttons='[["font", ["bold"]],["insert", ["link"]]]'>{{ get_setting('cookies_agreement_text') }}</textarea>
                            </div>
    					</div>
                        <div class="form-group row">
    				...
    				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea name="website_popup_content" rows="4" class="sismoo-text-editor form-control" >{{ get_setting('website_popup_content') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
