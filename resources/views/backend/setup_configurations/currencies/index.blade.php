            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control sismoo-selectpicker" name="system_default_currency" data-live-search="true">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control sismoo-selectpicker" name="symbol_format">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control sismoo-selectpicker" name="decimal_separator">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control sismoo-selectpicker" name="no_of_decimals">
    ...
    <script type="text/javascript">
        ...
        function update_currency_status(el){
            ...
            $.post('{{ route('currency.update_status') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    SISMOO.plugins.notify('success', '{{ translate('Currency Status updated successfully') }}');
                }
                else{
