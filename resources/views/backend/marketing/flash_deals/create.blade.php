            ...
            <div class="card-body">
                <form action="{{ route('flash_deals.store') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <select name="text_color" id="text_color" class="form-control sismoo-selectpicker" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control sismoo-date-range" name="date_range" placeholder="Select Date" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select name="products[]" id="products" class="form-control sismoo-selectpicker" multiple required data-placeholder="{{ translate('Choose Products') }}" data-live-search="true" data-selected-text-format="count">
