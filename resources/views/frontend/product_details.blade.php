            ...
            <div class="bg-white shadow-sm rounded p-3">
                <div class="row">
                    <div class="col-xl-5 col-lg-6 mb-4">
                        <div class="sticky-top z-3 row gutters-10">
                            ...
                            <div class="col order-1 order-md-2">
                                <div class="sismoo-carousel product-gallery" data-nav-for='.product-gallery-thumb' data-fade='true' data-auto-height='true'>
                            ...
                            <div class="col-12 col-md-auto w-md-80px order-2 order-md-1 mt-3 mt-md-0">
                                <div class="sismoo-carousel product-gallery-thumb" data-items='5' data-nav-for='.product-gallery' data-vertical='true' data-vertical-sm='false' data-focus-select='true' data-arrows='true'>
                                    @foreach ($photos as $key => $photo)
                        ...
                        <div class="text-left">
                            ...
                            <div class="row align-items-center">
                                <div class="col-12">
                                    ...
                                    <span class="ml-1  bg-soft-primary"> {{ translate('Bonus Point') }}: {{ $detailedProduct->earn_point }}</span>
                                    @endif
                                </div>

                                {{-- @if (addon_is_activated('club_point'))
                                    <div class="col-auto bg-soft-primary">
                                        {{ translate('BP') }}:
                                        <span class="fw-700 float-right">{{ $detailedProduct->earn_point }}</span>
                                    </div>
                                @endif --}}
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="sismoo-radio-inline">
                                                ...
                                                <label class="sismoo-megabox pl-0 mr-2" data-toggle="tooltip" data-title="{{ \App\Color::where('code', $color)->first()->name }}">
                                                    <input
                                                        type="radio"
                                                        name="color"
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="product-quantity d-flex align-items-center">
                                            <div class="row no-gutters align-items-center sismoo-plus-minus mr-3" style="width: 130px;">
                            ...
                            <div class="mt-3">
                                @if ($detailedProduct->external_link != null)
                                    <a type="button" class="btn addtocart-button mr-2 add-to-cart fw-600" href="{{ $detailedProduct->external_link }}">
                                        <i class="las la-shopping-bag"></i>
                                        <span class="d-none d-md-inline-block"> {{ translate('Add to cart')}}</span>
                                    </a>
                                    <a type="button" class="btn paybutton buy-now fw-600" href="{{ $detailedProduct->external_link }}">
                                        <i class="la la-shopping-cart"></i> {{ translate('Buy Now')}}
                                    </a>
                                @else
                                    <button type="button" class="btn addtocart-button mr-2 add-to-cart fw-600" onclick="addToCart()">
                                        <i class="las la-shopping-bag"></i>
                                        <span class="d-none d-md-inline-block"> {{ translate('Add to cart')}}</span>
                                    </button>
                                    <button type="button" class="btn paybutton buy-now fw-600" onclick="buyNow()">
                                        <i class="la la-shopping-cart"></i> {{ translate('Buy Now')}}
                                    </button>
                                @endif
                    ...
                    <div class="col-xl-2 col-lg-2">
                        <h5>Fluid Car Rear Trunk Tail Light Area Illumination Rear Brake Four Colors Car Type Flow Car Light Tailgate Turn Signal</h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row gutters-10">
                ...
                <div class="col-xl-9 order-0 order-xl-1">
                    <div class="bg-white mb-3 shadow-sm rounded">
                        <div class="nav border-bottom sismoo-nav-tabs">
                        ...
                        <div class="tab-content pt-0">
                            <div class="tab-pane fade active show" id="tab_default_1">
                                <div class="p-4">
                                    <div class="mw-100 overflow-hidden text-left sismoo-editor-data">
                    ...
                    <div class="bg-white rounded shadow-sm">
                        ...
                        <div class="p-3">
                            <div class="sismoo-carousel gutters-5 half-outside-arrow" data-items="5" data-xl-items="3" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='true'>
                                ...
                                <div class="carousel-box">
                                    <div class="sismoo-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                                        <div class="">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <form class="form-default" role="form" action="{{ route('cart.login.submit') }}" method="POST">
                            ...
                            <div class="row mb-2">
                                <div class="col-6">
                                    <label class="sismoo-checkbox">
                                        <input type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}>
                                        <span class=opacity-60>{{  translate('Remember Me') }}</span>
                                        <span class="sismoo-square-check"></span>
                                    </label>
                                </div>
    ...
    <script type="text/javascript">
        ...
        function CopyToClipboard(e) {
            ...
            try {
                ...
                SISMOO.plugins.notify('success', '{{ translate('Link copied to clipboard') }}');
            } catch (err) {
                SISMOO.plugins.notify('danger', '{{ translate('Oops, unable to copy') }}');
            }
            $temp.remove();
            ...
            // }
            // SISMOO.plugins.notify('success', 'Copied');
        }
