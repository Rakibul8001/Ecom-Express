...
{{-- end user bar right fixed --}}
            ...
            <div class="row gutters-10 position-relative">
                ...
                <div class="@if($num_todays_deal > 0) col-lg-7 @else col-lg-9 @endif">
                    @if (get_setting('home_slider_images') != null)
                        <div class="sismoo-carousel dots-inside-bottom mobile-img-auto-height" data-arrows="true" data-dots="true" data-autoplay="true">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="mb-3 mb-lg-0">
                        <a href="{{ json_decode(get_setting('home_banner1_links'), true)[$key] }}" class="d-block text-reset">
                            <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset($banner_1_imags[$key]) }}" alt="{{ env('APP_NAME') }} promo" class="img-fluid lazyload w-100" style="padding: 4px;height: 153px;">
                        </a>
                    </div>
                    @endforeach
                </div>
    ...
    <section class="mb-4" id="box-link3">
        <div class="container">
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                ...
                <div class="d-flex flex-wrap mb-3 align-items-baseline border-bottom">
                    ...
                    <div class="sismoo-count-down ml-auto ml-lg-3 align-items-center" data-date="{{ date('Y/m/d H:i:s', $flash_deal->end_date) }}"></div>
                ...
                <div class="sismoo-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true'>
            ...
            <div class="container">
                <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                   <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class=" mb-4">
                                <form class="form-inline" method="POST" action="{{ route('subscribers.store') }}" style="float: right; width:100%; margin-top:25px;">
                                    @csrf
                                    <div class="form-group mb-0" style="width:80%;">
                                        <input type="email" class="form-control" placeholder="{{ translate('Your Email Address') }}" name="email" required style="border-radius: 25px; width:100%;">
                                    </div>
