    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-8 mx-auto">
                <div class="row sismoo-steps arrow-divider">
                    <div class="col done">
                            ...
                            <div class="row border-top pt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="row gutters-5">
                                        <div class="col-6">
                                            <label class="sismoo-megabox d-block bg-white mb-0">
                                                <input
                                                    type="radio"
                                                    ...
                                                    checked
                                                >
                                                <span class="d-flex p-3 sismoo-megabox-elem">
                                                    <span class="sismoo-rounded-check flex-shrink-0 mt-1"></span>
                                    ...
                                    <div class="mt-4 pickup_point_id_admin d-none">
                                        <select
                                            class="form-control sismoo-selectpicker"
