                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="sticky-top z-3 row gutters-10 flex-row-reverse">
                            @if($detailedProduct->photos != null)
                                ...
                                @endphp
                                <div class="col">
                                    <div class="sismoo-carousel product-gallery" data-nav-for='.product-gallery-thumb' data-fade='true'>
                                ...
                                <div class="col-auto w-90px">
                                    <div class="sismoo-carousel carousel-thumb product-gallery-thumb" data-items='5' data-nav-for='.product-gallery' data-vertical='true' data-focus-select='true'>
                                        @foreach ($photos as $key => $photo)
