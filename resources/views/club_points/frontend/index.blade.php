    ...
    <section class="py-5">
        <div class="container">
            <div class="d-flex align-items-start">
                ...
                <div class="sismoo-user-panel">
                    <div class="sismoo-titlebar mt-2 mb-4">
    ...
    <script type="text/javascript">
        function convert_point(el)
        {
            $.post('{{ route('convert_point_into_wallet') }}',{_token:'{{ csrf_token() }}', el:el}, function(data){
                if (data == 1) {
                    location.reload();
                    SISMOO.plugins.notify('success', '{{ translate('Convert has been done successfully Check your Wallets') }}');
                }
                else {
